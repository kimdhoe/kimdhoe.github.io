    ...
    return (
      <Layout>
        <div>
          ...
          <p>
            프론트 개발자로서 솔 르윗이라는 작가가 유난히 반가운 것은 우리가 전시 설치 기사가 되어 시각적인 결과물을 만들어내는 연습을 하기에 최상의 자료를 제공하기 때문이다.
            혹시 비슷한 생각을 가진 분이 있다면 이미 Solving Sol이라는 프로젝트가 있으니 확인해보시면 되겠다.
          </p>
